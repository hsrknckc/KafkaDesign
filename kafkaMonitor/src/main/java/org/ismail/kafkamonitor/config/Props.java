...
public class Props {
    ...
    public static final String username = "broker-admin";
    public static final String password = "Bro123";
    ...
    public Props() {
        ...
        monitorProperties.setProperty("sasl.jaas.config","org.apache.kafka.common.security.scram.ScramLoginModule required username=\"" + username + "\" password=\"" + password + "\";");
